...
namespace LeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20230620135512_AddedMoreAuditFields")]
            ...
            modelBuilder.Entity("LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 6, 20, 13, 55, 12, 735, DateTimeKind.Local).AddTicks(6126),
                            DateModified = new DateTime(2023, 6, 20, 13, 55, 12, 735, DateTimeKind.Local).AddTicks(6140),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
