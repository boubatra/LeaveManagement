...
namespace LeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20230525140717_InitialMigration")]
            ...
            modelBuilder.Entity("LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 5, 25, 14, 7, 17, 740, DateTimeKind.Local).AddTicks(936),
                            DateModified = new DateTime(2023, 5, 25, 14, 7, 17, 740, DateTimeKind.Local).AddTicks(948),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
